...
namespace BOL_business_object_layer_
{
    ...
    public partial class WebAppEntities : DbContext
    {
        ...
        public virtual ObjectResult<JoinTables> Package_Confirmation_Email1(Nullable<int> iD)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<JoinTables>("Package_Confirmation_Email1", iDParameter);
        }
    
        public virtual ObjectResult<tbl_MakeMyTrip> Package_Confirmation_Email1(Nullable<int> iD, MergeOption mergeOption)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<tbl_MakeMyTrip>("Package_Confirmation_Email1", mergeOption, iDParameter);
        }
    
        //public virtual ObjectResult<tbl_MakeMyTrip> Package_Confirmation_Email2(Nullable<int> iD)
        //{
        //    var iDParameter = iD.HasValue ?
        //        new ObjectParameter("ID", iD) :
        //        new ObjectParameter("ID", typeof(int));
    
        //    return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<tbl_MakeMyTrip>("Package_Confirmation_Email2", iDParameter);
        //}
